...
Generate 0-3 prerequisite subtopics that are directly essential for understanding the given topic. Do not include any topics that are too much simpler than the given topic.
